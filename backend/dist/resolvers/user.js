...
let UserResolvers = class UserResolvers {
    register({ em }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                options.password = yield argon2_1.default.hash(options.password);
                let user = em.create(User_1.User, options);
    ...
    login(context, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let verify = yield argon2_1.default.verify(user.password, options.password);
            if (!verify) {
                return {
